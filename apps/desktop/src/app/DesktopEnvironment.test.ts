...
describe("DesktopEnvironment", () => {
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.appUserModelId, "com.alxs.t3code.typed-swiftui.desktop.dev");
      assert.equal(environment.linuxWmClass, "t3code-typed-swiftui-dev");
      assert.deepEqual(
  ...
  it.effect("keeps implicit development state separate from production state", () =>
    Effect.gen(function* () {
      ...
      assert.equal(
        ...
        "/Users/alice/Library/Application Support/T3CodeTypedSwiftUI/dev",
      );
      assert.equal(
        production.stateDir,
        "/Users/alice/Library/Application Support/T3CodeTypedSwiftUI/userdata",
      );
    }),
  );
  ...
  it.effect("uses a configured app user model id override", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.appUserModelId, "com.alxs.t3code.typed-swiftui.desktop.dev.local");
    }),
  );
