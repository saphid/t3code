...
export const openStatsWindow = DesktopIpc.makeIpcMethod({
  channel: IpcChannels.OPEN_STATS_WINDOW_CHANNEL,
  payload: Schema.Void,
  result: Schema.Void,
  handler: Effect.fn("desktop.ipc.window.openStatsWindow")(function* () {
