...
import * as VoiceDictationService from "./voice/VoiceDictationService.ts";
...
const makeWsRpcLayer = (
  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      const voiceDictation = yield* VoiceDictationService.VoiceDictationService;
      ...
      return WsRpcGroup.of({
        ...
        [WS_METHODS.voiceGetStatus]: (input) =>
          observeRpcEffect(WS_METHODS.voiceGetStatus, voiceDictation.getStatus(input.localeHint), {
            "rpc.aggregate": "voice",
          }),
        [WS_METHODS.voiceInstall]: (input) =>
          observeRpcEffect(WS_METHODS.voiceInstall, voiceDictation.install(input.localeHint), {
            "rpc.aggregate": "voice",
          }),
        [WS_METHODS.voiceTranscribe]: (input) =>
          observeRpcEffect(WS_METHODS.voiceTranscribe, voiceDictation.transcribe(input), {
            "rpc.aggregate": "voice",
          }),
