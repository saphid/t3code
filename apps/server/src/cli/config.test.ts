            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  T3CODE_PORT: "4001",
                  T3CODE_HOST: "0.0.0.0",
                  T3CODE_ADVERTISED_HOST: "https://forwarded.example.com/t3",
                  T3CODE_HOME: baseDir,
  ...
  it.effect("uses CLI flags when provided", () =>
    Effect.gen(function* () {
      ...
      const resolved = yield* resolveServerConfig(
        {
          ...
          advertisedHost: Option.some("https://tailnet.example.ts.net"),
      ...
      expect(resolved).toEqual({
        ...
        ...derivedPaths,
        host: "127.0.0.1",
        advertisedHost: "https://tailnet.example.ts.net",
        staticDir: undefined,
