...
export const RPC_REQUIRED_SCOPES = {
  ...
  [ORCHESTRATION_V2_WS_METHODS.getThreadHistoryPage]: AuthOrchestrationReadScope,
  [ORCHESTRATION_V2_WS_METHODS.getThreadCheckpointContext]: AuthOrchestrationReadScope,
