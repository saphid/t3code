...
import Migration038V2 from "./Migrations/038_OrchestrationV2.ts";
import Migration039V2 from "./Migrations/039_OrchestrationV2Subagents.ts";
import Migration040V2 from "./Migrations/040_OrchestrationV2Foundation.ts";
import Migration041V2 from "./Migrations/041_OrchestrationV2ProviderSessionBindings.ts";
import Migration042V2 from "./Migrations/042_OrchestrationV2ThreadLaunchWorkflows.ts";
import Migration043V2 from "./Migrations/043_ApplicationEventSource.ts";
import Migration044V2 from "./Migrations/044_OrchestrationV2EffectCancellation.ts";
import Migration045V2 from "./Migrations/045_ScheduledTasks.ts";
import Migration046V2 from "./Migrations/046_LegacyV1ImportState.ts";
...
export const migrationEntries = [
  ...
  [41, "OrchestrationV2", Migration038V2],
  [42, "OrchestrationV2Subagents", Migration039V2],
  [43, "OrchestrationV2Foundation", Migration040V2],
  [44, "OrchestrationV2ProviderSessionBindings", Migration041V2],
  [45, "OrchestrationV2ThreadLaunchWorkflows", Migration042V2],
  [46, "ApplicationEventSource", Migration043V2],
  [47, "OrchestrationV2EffectCancellation", Migration044V2],
  [48, "ScheduledTasks", Migration045V2],
  [49, "LegacyV1ImportState", Migration046V2],
] as const;
