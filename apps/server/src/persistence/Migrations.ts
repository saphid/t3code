...
import Migration037V2 from "./Migrations/037_OrchestrationV2.ts";
import Migration038V2 from "./Migrations/038_OrchestrationV2Subagents.ts";
import Migration039V2 from "./Migrations/039_OrchestrationV2Foundation.ts";
import Migration040V2 from "./Migrations/040_OrchestrationV2ProviderSessionBindings.ts";
import Migration041V2 from "./Migrations/041_OrchestrationV2ThreadLaunchWorkflows.ts";
import Migration042V2 from "./Migrations/042_ApplicationEventSource.ts";
import Migration043V2 from "./Migrations/043_OrchestrationV2EffectCancellation.ts";
import Migration044V2 from "./Migrations/044_ScheduledTasks.ts";
import Migration045V2 from "./Migrations/045_LegacyV1ImportState.ts";
...
export const migrationEntries = [
  ...
  [41, "OrchestrationV2", Migration037V2],
  [42, "OrchestrationV2Subagents", Migration038V2],
  [43, "OrchestrationV2Foundation", Migration039V2],
  [44, "OrchestrationV2ProviderSessionBindings", Migration040V2],
  [45, "OrchestrationV2ThreadLaunchWorkflows", Migration041V2],
  [46, "ApplicationEventSource", Migration042V2],
  [47, "OrchestrationV2EffectCancellation", Migration043V2],
  [48, "ScheduledTasks", Migration044V2],
  [49, "LegacyV1ImportState", Migration045V2],
] as const;
