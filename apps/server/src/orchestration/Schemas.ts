import {
  ...
  ThreadProviderProcessTerminatedPayload as ContractsThreadProviderProcessTerminatedPayloadSchema,
...
export const ThreadProviderProcessTerminatedPayload =
  ContractsThreadProviderProcessTerminatedPayloadSchema;
