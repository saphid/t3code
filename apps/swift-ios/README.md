...
build comparison line. Unless that explicit base already resolves locally, a
Debug install refreshes the selected `upstream` or `origin` remote
noninteractively before calculating the comparison. Run with
