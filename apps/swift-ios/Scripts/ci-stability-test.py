...
SUITES = ['WebSocketRPCRaceTests', 'WebSocketRPCDecodingTests', 'NativeMultiEnvironmentTests', 'NativeRetryIdentityTests', 'NativeThreadCatchUpTests', 'FeatureRootModelTests', 'FeatureOutboxStoreTests', 'FeatureMessageAgeTests', 'NativeTranscriptTimelineTests', 'HomeEnvironmentFilterTests', 'AppFlowStagedCredentialsTests', 'CodexVisualizationTests', 'MarkdownDocumentTests', 'MarkdownRenderCacheTests', 'WorkspaceContractTests', 'TransportReliabilityTests', 'PairingServiceTests', 'PairingTokenPrecedenceTests', 'T3ClientServerConfigTests', 'ConnectionDetailsTests', 'LocalNetworkAccessCheckerTests', 'EnvironmentStoreVersionTests', 'FeatureAttachmentUploadCoordinatorTests', 'FeatureAsyncGenerationTests', 'RemoteCheckoutPathTests', 'FeatureToolStateTests', 'TranscriptViewportGeometryTests', 'DailyUXSidebarTests', 'TerminalAccessibilityRegressionTests']
...
def retain_tested_app(root, runner_temp, receipt):
    ...
    # Upstream Debug does not declare an injected commit key; source provenance is the exact checkout and source hashes.
...
def main():
    ...
    try:
        ...
        receipt["expectedChannel"] = "verification-only"
