...
struct FeatureComposerView: View {
    // Fully qualified: the app's own wire-model `Environment` type shadows
    // the SwiftUI property wrapper in this scope.
    ...
    var body: some View {
        composerSurface
            ...
            .onChange(of: scenePhase) {
                // Backgrounding stops capture anyway; finalize what was said
                // so the model cannot come back believing the mic is still
                // live.
    ...
    private var dictationButton: some View {
        FeatureVoiceDictationButton(
            ...
            onBegin: {
                ...
                if !voiceDictationKeyboardEnabled, focused.wrappedValue {
