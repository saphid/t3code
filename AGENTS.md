...
- `apps/swift-ios` is the standalone native SwiftUI app for iOS, with its own Xcode project, UI implementation, and sandbox identities.
...
- `apps/swift-ios` - Standalone native SwiftUI client for iOS.
