...
test("reports exact and rebased commits without matching titles or dirty files", async (t) => {
  ...
  await NodeAssert.rejects(comparePatches(repo, "ov2", "nightly"), /Missing Nightly source commit/);
