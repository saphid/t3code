...
/** Stable built-in catalog used by platform artifact generators. */
export function getBuiltInThemeDefinitions(): ReadonlyArray<ThemeDefinition> {
  return BUILT_IN_THEME_DEFINITIONS;
}
